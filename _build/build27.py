...
.dt .ds .u a{color:var(--instr-t);text-decoration:none;border-bottom:1px solid transparent}
.dt .ds .u a:hover{border-color:var(--instr-t)}
...
.dt pre{background:var(--surface-2);border:1px solid var(--rule);border-radius:4px;padding:14px 16px;
