...
<section class="band" style="border-top:0;padding-top:0">
  <div class="shell dt">
    ...
    <div class="note"><strong>Drop rates.</strong> The sightings file is a count of what we
      ...
      <br><br><strong>Completeness.</strong> Thirteen dungeons of far more, one plane of
      three surveyed in depth, and a sample of a few dozen play sessions. Everything here
      states what it does not know; that is the most useful field in the file.</div>
